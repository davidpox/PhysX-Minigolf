...
//			pairFlags |= PxPairFlag::eNOTIFY_CONTACT_POINTS;
	...
	public:
		...
		virtual void CustomInit() 
		{
			...
			box = new Box(PxTransform(PxVec3(.0f,2.0f,.0f)), PxVec3(.2f, 0.2f, 5.0f));
			...
			RevoluteJoint joint(nullptr, PxTransform(PxVec3(10.f,5.f,0.f),PxQuat(PxPi/2,PxVec3(0.f,1.f,0.f))), box, PxTransform(PxVec3(0.f,0.0f,0.f)));
